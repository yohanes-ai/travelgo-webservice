...
$sql="select m_package.*,m_tour.name as name,m_location.name as location,SUM(m_tourpack.price) as price
from m_package
join m_tourpack on m_package.id=m_tourpack.package_id
left join m_location on m_location.id=m_package.location_id
